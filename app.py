...
def main():
   ...
   <center><p style="font-size:30px;color:white;margin-top:10px;">NAME: Tanishk Khandelwal</p></center>
   <center><p style="font-size:25px;color:white;margin-top:0px;">__ PIET18CS143 __ Sec: C __ Roll No 32 __</p></center>
   </div>
   </div>
   </div>
   """
